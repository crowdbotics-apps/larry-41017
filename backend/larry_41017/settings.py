"""
Django settings for larry_41017 project.
...
WSGI_APPLICATION = 'larry_41017.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "larry_41017 API",
    "DESCRIPTION": "API documentation for larry_41017 App",
    "VERSION": "v1",
}
